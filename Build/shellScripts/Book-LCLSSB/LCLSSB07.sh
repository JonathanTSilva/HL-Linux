...
#------------------------ HEADER ----------------------------
#============================================================
# LCLSSB07.sh - Exercice 07 - take snapshots of specified
# directories and keep an archive of your data's past version
...
# Before, you need to create a daily archive location and grant access to it for certain users
# $ sudo mkdir /archive
